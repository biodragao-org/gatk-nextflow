...
//output_bam_sorted_tagged = file("s3://gfb-genomics/low_coverage_variants/gatk_ubams/bam/${sample_name}_sorted_tagged.bam")
//output_bam_sorted_tagged_index = file("s3://gfb-genomics/low_coverage_variants/gatk_ubams/bam/${sample_name}_sorted_tagged.bai")
...
//output_bam = file("s3://gfb-genomics/low_coverage_variants/gatk_ubams/bam/${sample_name}.bam")
//output_bam_index = file("s3://gfb-genomics/low_coverage_variants/gatk_ubams/bam/${sample_name}.bai")
